...
class EventsApi:
    ...
    def list_events(
        ...
        *,
        ...
        `Results are paginated similarly to logs </logs/guide/collect-multiple-logs-with-pagination>`_.
    ...
    def list_events_with_pagination(self, **kwargs):
        """Get a list of events.
    ...
    def search_events_with_pagination(self, **kwargs):
        """Search events.
