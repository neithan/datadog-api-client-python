...
class EventAttributes(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):
        ...
        :param duration: Duration in nanoseconds between the triggering of the event and its recovery.
        ...
        :param monitor_id: ID of Monitor that triggered the event. When an event isn't related to a monitor, this field is empty.
        ...
        :param source_type_name: The type of event being posted.
            For example, ``nagios`` , ``hudson`` , ``jenkins`` , ``my_apps`` , ``chef`` , ``puppet`` , ``git`` , ``bitbucket``.
