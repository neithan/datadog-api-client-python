...
class SecurityMonitoringSignalTriageAttributes(ModelNormal):
    ...
    def __init__(self, incident_ids, state, *args, **kwargs):
        """
        Attributes describing a triage state update operation over a security signal.

        :param archive_comment: Optional comment that will be displayed on archived signals.
        :type archive_comment: str, optional

        :param archive_comment_timestamp: Timestamp at which the last edit to the comment has been made.
        ...
        :param state_update_timestamp: Timestamp at which the last update to the signal state has been made.
    ...
    @classmethod
    def _from_openapi_data(cls, incident_ids, state, *args, **kwargs):
